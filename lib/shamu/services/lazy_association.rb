module Shamu
  module Services
    ...
    module LazyAssociation
      EXCLUDE_PATTERN = /\A(block_given\?|id|send|public_send|iterator|object_id|to_model_id|binding|class|kind_of\?|is_a\?|instance_of\?|respond_to\?|p.+_methods|__.+__)\z/
      MUTEX = Mutex.new

      def self.class_for(klass)
